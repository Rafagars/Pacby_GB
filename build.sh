...
/opt/gbdk/bin/lcc -Wa-l -Wl-m -Wl-j -Wm-yn"PACBY" -o pacby.gb src/Pacby_sprites.o main.o src/functions.o src/characters.o src/Tiles.o src/entity.o src/BG1.o src/floormap_full_segments.o  src/windowLayer.o
